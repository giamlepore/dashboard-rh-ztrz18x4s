    ...
    <div className="p-6 md:p-8 space-y-6 animate-fade-in bg-[#F9FAFB] dark:bg-zinc-950 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-ink/60 dark:text-cream/60 mt-2 max-w-lg">
        ...
        <div className="flex gap-3">
          ...
          <button className="bg-ink text-cream px-4 py-2 rounded-full text-sm font-medium hover:bg-ink/90 flex items-center gap-2 transition-all shadow-lg hover:shadow-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-min">
        {/* KPI Cards Row */}
        <div className="col-span-1 md:col-span-4 bg-white dark:bg-zinc-900 border border-ink/5 rounded-[24px] p-6 flex items-center gap-4 hover:shadow-md transition-all">
        ...
        <div className="col-span-1 md:col-span-8 bg-cream border border-ink/5 rounded-[32px] p-8 min-h-[400px]">
        ...
        <div className="col-span-1 md:col-span-4 bg-ink rounded-[32px] p-8 text-cream flex flex-col relative overflow-hidden">
        ...
        <div className="col-span-1 md:col-span-6 bg-periwinkle rounded-[32px] p-8 min-h-[350px]">
          <div className="flex items-center gap-2 mb-6">
        ...
        <div className="col-span-1 md:col-span-6 bg-sage rounded-[32px] p-8 min-h-[350px]">
          <div className="flex items-center gap-2 mb-6">
